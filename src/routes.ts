...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/examples',
            ...
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.getAllExamples)),

            async function ExampleController_getAllExamples(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
        ...
        app.post('/examples',
            ...(fetchMiddlewares<RequestHandler>(ExampleController)),
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.createExample)),

            async function ExampleController_createExample(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"name":{"dataType":"string","required":true}}},
            };
        ...
        app.put('/examples/:id',
            ...(fetchMiddlewares<RequestHandler>(ExampleController)),
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.updateExample)),

            async function ExampleController_updateExample(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"name":{"dataType":"string","required":true}}},
            };
        ...
        app.delete('/examples/:id',
            ...(fetchMiddlewares<RequestHandler>(ExampleController)),
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.deleteExample)),

            async function ExampleController_deleteExample(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
